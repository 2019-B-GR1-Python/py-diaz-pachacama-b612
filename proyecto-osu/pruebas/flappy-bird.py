...
images = {
    'start_thing': image.load('osu.jpeg'),
    'background': image.load('osu.jpeg'),
    'ground': image.load('osu.jpeg'),
    'pole': image.load('osu.jpeg'),
    'score_board': image.load('osu.jpeg')
}
...
class Flappy_Class:
    ...
    def __init__(self):
        ...
        self.flap_1 = transform.scale(image.load('osu.jpeg'), (self.width, self.height))
        self.flap_2 = transform.scale(image.load('osu.jpeg'), (self.width, self.height))
        self.flap_3 = transform.scale(image.load('osu.jpeg'), (self.width, self.height))
...
def game():
    ...
    if stuff['game_status'] == 'dead':
        ...
        window.blit(transform.scale(images['score_board'], (math.ceil(width), height)),
                    ((windowX - width) / 2, (windowY - height) / 2))
        ...
        window.blit(restart_message,
                    ((windowX - restart_message_rect.width) / 2, windowY - restart_message_rect.height - 10))
